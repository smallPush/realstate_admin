...
final class GetAllApartmentsQueryTest extends TestCase
{
    ...
    public function testExecuteWithGroupIdsReturnsFilteredApartments(): void
    {
        $repositoryMock = $this->createMock(ApartmentRepositoryInterface::class);

        $apartment1 = new Apartment('Piso 1', 'Calle 1', 1000, true, 1);
        $apartment2 = new Apartment('Piso 3', 'Calle 3', 1500, true, 1);
